package org.sweppy.waveberry.utils;
...
public class CustomFontRenderer
{
    ...
    private Font getFontByName(final String name) throws IOException, FontFormatException {
        if (name.equalsIgnoreCase("lato hairline")) {
            return this.getFontFromInput("/assets/minecraft/waveberry/fonts/Lato-Hairline.ttf");
        }
        if (name.equalsIgnoreCase("lato black")) {
            return this.getFontFromInput("/assets/minecraft/waveberry/fonts/Lato-Black.ttf");
        }
        if (name.equalsIgnoreCase("lato bold")) {
            return this.getFontFromInput("/assets/minecraft/waveberry/fonts/Lato-Bold.ttf");
        }
        if (name.equalsIgnoreCase("Main Menu")) {
            return this.getFontFromInput("/assets/minecraft/waveberry/fonts/Main-Menu.ttf");
        }
        return this.getFontFromInput("/assets/minecraft/waveberry/fonts/Lato-Light.ttf");
    }
