...
public class ModDrawer {
    ...
    public static ModDrawer instance = new ModDrawer();

    public static ModDrawer getInstance() {
        return instance;
    }
    ...
    public static void drawOutline(int x1, int y1,int x2, int y2,int color) {
        Gui.drawHorizontalLine(x1,x2,y1,color);
        Gui.drawHorizontalLine(x1,x2,y2,color);

        Gui.drawVerticalLine(x1,y1,y2,color);
        Gui.drawVerticalLine(x2,y1,y2,color);
    }

    public static void drawBigOutline(int x1, int y1,int x2, int y2,int color) {
        Gui.drawHorizontalLine(x1,x2,y1,color);
        Gui.drawHorizontalLine(x1,x2,y2,color);
        Gui.drawHorizontalLine(x1,x2,y1+1,color);
        Gui.drawHorizontalLine(x1,x2,y2-1,color);



        Gui.drawVerticalLine(x1,y1,y2,color);
        Gui.drawVerticalLine(x2,y1,y2,color);
        Gui.drawVerticalLine(x1 + 1,y1,y2,color);
        Gui.drawVerticalLine(x2 - 1,y1,y2,color);
    }
